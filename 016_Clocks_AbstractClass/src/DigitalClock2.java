...
/**
 * Makes a visual for the clock
 * <p>
 * extends JFrame to create a window for the clock, and implements ActionListener.
 * This is a full class, all the methods have full code in them.
 * <p>
 * @author Ben Harper
 * @version 1.0
 * @since 1.0
